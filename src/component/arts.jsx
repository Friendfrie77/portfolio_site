...
function Arts(){
    ...
    return(
        <section className="content" ref={ref} id='arts'>
            <div className="content_hero arts_hero">
                <h1 className='content_hero_header'>Fine Arts</h1>
            </div>
            <ul className='projects'>
                ...
                <li className="panel project_three" id="arts-three">
                    <div className='panel_description'>
                        <div>
                            <h3 className='project_title'>Wedding Sign</h3>
